...
description: Generate a single PR review guide from a feature docs directory and current git change scope. Use when the user asks for reviewer-facing documentation that explains what was built, why, how to review it, and where risks or gaps remain.
---
