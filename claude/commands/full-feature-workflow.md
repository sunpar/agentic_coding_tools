...
8. Read {git-root}/.claude/commands/code-review_personal.md and execute it, linking both {git-root}/docs/feature-summary-2.md and the original file: $ARGUMENTS and saving output to {git-root}/docs/code-review-personal.md
